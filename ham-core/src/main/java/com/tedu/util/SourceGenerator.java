...
public class SourceGenerator {
    ...
    public static void generateQuery(String objName) throws Exception{
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("ham-core/src/main/java/com/tedu/query/"+objName+"Query.java"));
        String line = null;
    ...
    public static void generateDao(String objName) throws Exception{
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("ham-core/src/main/java/com/tedu/dao/"+objName+"Mapper.java"));
        String line = null;
        while((line = br.readLine()) != null){
            line = line.replace("Demo", objName);
            bw.write(line);
    ...
    public static void generateService(String objName) throws Exception{
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("ham-core/src/main/java/com/tedu/service/"+objName+"Service.java"));
        String line = null;
        while((line = br.readLine()) != null){
            line = line.replace("Demo", objName);
            bw.write(line);
    ...
    public static void generateServiceImpl(String objName) throws Exception{
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("ham-core/src/main/java/com/tedu/service/impl/"+objName+"ServiceImpl.java"));
        String line = null;
        while((line = br.readLine()) != null){
            line = line.replace("Demo", objName);
