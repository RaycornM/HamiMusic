...
<html>
<head>
    <title>tx 音乐是生活的调味剂update</title>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <input type="text" class="col-sm-6 col-xs-12 parsley-validated" required="" name="srname" id="srname" value="${songer.srid}" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div id="examples" class="section examples-section">
                                            ...
                                            <input type="hidden" id="pic" name="pic" value="${songer.pic}">
