    ...
    <script>
        ...
        $(function () {
            ...
            $(".filter p a").click(function () {
                ...
                window.location.href = "/portal/search.do?tid=" + tid + "&isHot=" + isHot + "&isNew=" + isNew;
            })
        ...
        function loadMore() {
            ...
            window.location.href = "/portal/search.do?&tid="+ tid + "&isHot=" + isHot + "&isNew=" + isNew + "&pageSize=" + pageSize + "&pageNoPortal=" + pageNoPortal;
        }
        ...
        function playsongs() {
            ...
            window.open("/portal/play?sids="+sids,"play");
        }

        function play(sid) {
            window.open("/portal/play?sids="+sid,"play");
        }
    ...
    <div class="wrapper">
        ...
        <div class="sidebar" data-spm="1392350021">
            <div class="nav">
                ...
                <a class="songs current" href="/portal/search.do"><b></b>歌曲</a>
                <a class="albums" href="#"><b></b>专辑<sup>无损</sup></a>
            </div>
            <div class="genre">
                <c:forEach items="${mtypes}" var="mtype">
                    <a href="/portal/search.do?tid=${mtype.tid}"><b></b>${mtype.tname}</a>
                </c:forEach>
            </div>
        </div>
    </div>
